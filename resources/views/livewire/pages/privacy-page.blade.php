<div>
    @section('titles')
        <title>{{__('Aviso de Privacidad')}} - Espacio Marina & Golf</title>
    @endsection


    <section class="position-relative mb-6">

        <img src="{{asset('img/fachada-atras-alberca.webp')}}" alt="Aviso de privacidad Espacio Marina & Golf" class="w-100" style="height: 25vh; object-fit:cover; object-position:bottom;">
